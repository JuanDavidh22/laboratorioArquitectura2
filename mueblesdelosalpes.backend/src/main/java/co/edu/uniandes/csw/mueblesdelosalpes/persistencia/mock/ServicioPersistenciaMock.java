...
public class ServicioPersistenciaMock implements IServicioPersistenciaMockRemote, IServicioPersistenciaMockLocal {
    ...
    public ServicioPersistenciaMock() {
        if (vendedores == null) {
            ...
            ofertas.add(new Oferta(1L, 1L, "client", 5000.0));
            ofertas.add(new Oferta(2L, 1L, "client", 4000.0));
            ofertas.add(new Oferta(3L, 1L, "client", 6000.0));
            ofertas.add(new Oferta(4L, 1L, "client", 7000.0));
